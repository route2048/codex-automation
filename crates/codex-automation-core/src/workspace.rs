...
fn target_config_text(
    ...
    Ok([
        ...
        "Follow the target repository AGENTS.md files from the shared worktree.".to_owned(),
        "Use the shared worktree path for reading and edits; do not edit repo_path directly.".to_owned(),
        "Keep work scoped to the active workorder.".to_owned(),
